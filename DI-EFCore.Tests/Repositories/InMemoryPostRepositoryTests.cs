...
namespace DI_EFCore.Tests.Repositories {
    ...
    [TestClass]
    public class InMemoryPostRepositoryTests : PostRepositoryTests, IDisposable {

        private readonly DbConnection _connection;

        public InMemoryPostRepositoryTests() : base(new DbContextOptionsBuilder<AppDbContext>()
